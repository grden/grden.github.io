import { EMAIL, GITHUB, LINKEDIN, CV } from "../../constants/contacts";
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                <div className="flex flex-col justify-between items-left md:flex-row">
                    <p className="text-sm text-left text-gray-500 font-normal mb-3 md:mb-0">
                        ...
                        <p className="cursor-pointer hover:text-gray-800 transition-colors underline inline" onClick={() => window.open(CV, "_blank")}>CV</p><span className="relative bottom-[-0.1em] ml-0.5">↗</span>
                        &nbsp; | &nbsp;
