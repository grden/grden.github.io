...
I was a Software Engineer Intern at <p className="cursor-pointer underline inline" onClick={() => window.open("https://www.linkedin.com/in/bumsoo-kim-439b273/", "_blank")}>M5ers</p> ↗, a pre-launch startup, in the Winter of 2024.
...
I tried to make the most of my time there. Even though we had no car,
...
<img 
  ...
  className="rounded-lg w-1/4 object-cover my-4 mr-2" 
/>
<img 
...
<img 
  ...
  alt="Bay Area Photo" 
  className="rounded-lg w-2/4 object-cover my-4"
/>
</div>
