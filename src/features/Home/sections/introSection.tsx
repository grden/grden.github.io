    ...
    return (
        <>
            ...
            <p className="mt-8 mb-6 text-gray-600">I'm an undergraduate student at
                ...
                <br />My recent interests lie in <span className="text-black font-medium">Human-Computer Interaction</span>, alongside <span className="text-black font-medium">Frontend Development</span> — exploring ways to combine these disciplines to create more intuitive and engaging digital experiences.
            </p>
        </>
    )
}